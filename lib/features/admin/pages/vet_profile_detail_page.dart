...
class VetProfileDetailPage extends StatelessWidget {
  ...
  const VetProfileDetailPage({required this.profile, required this.api, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final ced = profile['cedula'] ?? '';
    final phone = profile['telefono'] ?? '';
    final address = profile['direccion'] ?? '';
    final colegio = profile['numero_colegio'] ?? '';
    final sector = profile['sector'] ?? '';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text('Información\nDel Perfil', textAlign: TextAlign.center, style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600)),
